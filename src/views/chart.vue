      ...
      <div class="map-box">
        <div class="tools">
            <div class="left">
                ...
                <div class="tips">(数据来源于汝州市数据研究中心)</div>
            </div>
        ...
        <div class="texted">
            <p class="title">注释</p>
            <p>1、汝州市土地流转指数是概括土地流转市场活跃水平的指标。</p>
            <p>2、指数上涨，表示土地流转市场趋于活跃。</p>
            <p>3、汝州市土地流转指数建立在汝州市平台汇聚和积累的海量交易行为数据基础之上，同时融入土地流转舆情数据、土地流转市场等数据，以指数</p>
            <p>形式反映汝州市土地流转市场现行状况，为描述与探索土地流转市场提供了一个便捷入口。</p>
  ...
  methods: {
    ...
    drawLine(id){
      ...
      this.charts.setOption({
           ...
           xAxis: {
                type: 'category',
                data: ['2019-02-10', '2019-02-10', '2019-02-10', '2019-02-10', '2019-02-10', '2019-02-10', '2019-02-10','2019-02-10', '2019-02-10', '2019-02-10', '2019-02-10']
            },
            yAxis: {
                type: 'value',
                axisLabel:{
