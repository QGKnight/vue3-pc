<template>
  <div class="page">
    <div class="main-auto page-head">
      <div class="btns">
        <div class="btn-one" :class="{actived:currentIndex==0}" @click="changeItem(0)">新闻动态</div>
        <div class="btn-one" :class="{actived:currentIndex==1}" @click="changeItem(1)">地方要闻</div>
        <div class="btn-one" :class="{actived:currentIndex==2}" @click="changeItem(2)">国家法规</div>
        <div class="btn-one" :class="{actived:currentIndex==3}" @click="changeItem(3)">汝州法规</div>
      </div>
      <div class="right">
        <span>关键字:</span>
