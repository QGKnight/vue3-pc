  ...
  <div class="page">
    <div class="boxs">
      <div class="cell celles">
        <span>所在地区：</span>
        <el-select v-model="provincy" placeholder="请选择">
          <el-option
      ...
      <div class="cell">
        <span>标段描述:</span>
        <el-input type="textarea" placeholder="请输入内容" v-model="name"></el-input>
      </div>
      <div class="cell">
        <span>图片上传:</span>
        <div class="upBox">
      ...
      <div class="btns">
        <div class="success">重新提交</div>
        <div class="danger" @click="cancelTool">取消申报</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    cancelTool() {
      this.$confirm("此操作将永久删除已上传文件资料, 是否继续?", "提示", {
